...
type Holiday = {
  date: string;  // Full date (e.g., "2025-05-01")
  name: string;
  apiHname: string;
};
...
const useFetchHolidayList = () => {
  ...
  useEffect(() => {
    // Mocking the holiday list for now, replace this with your actual API call if needed
    const HolidayList: Holiday[] = [
      { date: "2025-01-01", name: "New Year's Day", apiHname: "New Year's Day" },
      { date: "2025-01-14", name: "Pongal", apiHname: "Pongal" },
      { date: "2025-01-26", name: "Republic Day", apiHname: "Republic Day" },
      { date: "2025-03-31", name: "Ramzan(Idul Fitr)", apiHname: "Ramzan Id" },
      { date: "2025-04-14", name: "Tamil New Year's Day", apiHname: "Ambedkar Jayanti" },
      { date: "2025-05-01", name: "International Worker's Day", apiHname: "International Worker's Day" },
      { date: "2025-08-15", name: "Independence Day", apiHname: "Independence Day" },
      { date: "2025-08-27", name: "Vinayakar Chathurthi", apiHname: "Ganesh Chaturthi/Vinayaka Chaturthi" },
      { date: "2025-10-02", name: "Gandhi Jayanti", apiHname: "Mahatma Gandhi Jayanti" },
      { date: "2025-10-20", name: "Deepavali", apiHname: "Diwali/Deepavali" },
      { date: "2025-12-25", name: "Christmas", apiHname: "Christmas" },
    ];
